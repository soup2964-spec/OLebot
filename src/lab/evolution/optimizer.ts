import type { PageVariant, Section, ChangelogEntry } from "@/shared/schema/page";
...
import { chatJSONRetry, breederProvider } from "@/shared/llm";
import { variantNameForBreeding } from "@/lab/variants/display-name";
import {
