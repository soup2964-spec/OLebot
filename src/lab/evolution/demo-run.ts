...
import type { PersonaSet } from "@/shared/schema/persona";
...
import { makeRng, pickWeighted, type Rng } from "@/lab/simulation/rng";
import { analyzeGeneration, type VariantDecision } from "@/shared/stats/bayes";
