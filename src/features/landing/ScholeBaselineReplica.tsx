...
import { replicaHtmlWithGuard, staticReplicaPath } from "@/domains/replica/paths";
import { variantPageTitle } from "@/domains/variants/display-name";
import { trackCtaClick } from "@/features/shell/Clarity";
import { useVariantTrackingContext } from "@/domains/analytics/variant-context";
