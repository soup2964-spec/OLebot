import type { PageVariant, Section, ChangelogEntry } from "@/platform/schema/page";
import type { VariantMetrics } from "@/platform/schema/events";
import type { GenerationReport } from "@/platform/schema/experiment";
import { GENERATION_0 } from "@/content/variants";
import { chatJSONRetry, breederProvider } from "@/platform/llm";
import { variantNameForBreeding } from "@/domains/variants/display-name";
import {
