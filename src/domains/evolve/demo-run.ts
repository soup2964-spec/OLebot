...
import type { ExperimentRun, GenerationRun, AllocationSnapshot } from "@/platform/schema/experiment";
...
import { makeRng, pickWeighted, type Rng } from "@/domains/sim/rng";
import { analyzeGeneration, type VariantDecision } from "@/platform/stats/bayes";
