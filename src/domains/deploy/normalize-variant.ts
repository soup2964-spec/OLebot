...
import type { PageVariant, Section, SectionType } from "@/platform/schema/page";
import { REPLICA_SECTION_IDS, type ReplicaSectionId } from "@/domains/replica/baseline-copy";
